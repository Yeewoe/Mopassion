...
public class ImagePipelineConfigUtils {
    ...
    //小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "mopa_pic_small";

    //默认图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "mopa_pic_default";
    ...
    public static ImagePipelineConfig getDefaultImagePipelineConfig(Context context) {
        ...
        //默认图片的磁盘配置
        DiskCacheConfig diskCacheConfig = DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(new File(AppConstants.APP_ROOT_DIR))//缓存图片基路径
