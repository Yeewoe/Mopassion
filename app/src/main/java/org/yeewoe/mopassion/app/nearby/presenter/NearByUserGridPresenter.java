 ...
 */
public class NearByUserGridPresenter extends LinePresenter<NearByUserLineVo> {
     ...
     */
    public NearByUserGridPresenter(IContactFriendView view, NearByUserGridAdapter adapter, int firstPageCount, int nextPageCount) {
