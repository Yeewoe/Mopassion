...
public class FileUtils {
    ...
    private static String[] toSuffixes(String[] extensions) {
        ...
        for (int i = 0; i < extensions.length; i++) {
            suffixes[i] = "build/intermediates/exploded-aar/com.android.support/support-v4/23.2.0/res" + extensions[i];
        }
        return suffixes;
    }
    ...
    public static void deleteDirectory(File directory) throws IOException {
        ...
        if (!directory.delete()) {
            String message =
                    "Unable to delete directory " + directory + "build/intermediates/exploded-aar/com.android.support/support-v4/23.2.0/res";
