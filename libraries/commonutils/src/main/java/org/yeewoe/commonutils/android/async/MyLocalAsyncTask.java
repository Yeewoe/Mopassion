...
public abstract class MyLocalAsyncTask<Params, Progress, Result> {
    /**
    ...
    private static final int KEEP_ALIVE = CPU_COUNT + 2;
     ...
     */
    public final MyLocalAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final MyLocalAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                              Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final MyLocalAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(MyLocalAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
