...
// Source file: merge.proto at 418:1
...
public final class PBTrdFollowListRsp extends Message<PBTrdFollowListRsp, PBTrdFollowListRsp.Builder> {
  public static final ProtoAdapter<PBTrdFollowListRsp> ADAPTER = new ProtoAdapter_PBTrdFollowListRsp();
  ...
  public PBTrdFollowListRsp(Integer result, List<PBTrends> trends) {
    this(result, trends, ByteString.EMPTY);
  }

  public PBTrdFollowListRsp(Integer result, List<PBTrends> trends, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PBTrdFollowListRsp)) return false;
    PBTrdFollowListRsp o = (PBTrdFollowListRsp) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "PBTrdFollowListRsp{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<PBTrdFollowListRsp, Builder> {
    ...
    @Override
    public PBTrdFollowListRsp build() {
      return new PBTrdFollowListRsp(result, trends, buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_PBTrdFollowListRsp extends ProtoAdapter<PBTrdFollowListRsp> {
    ProtoAdapter_PBTrdFollowListRsp() {
      super(FieldEncoding.LENGTH_DELIMITED, PBTrdFollowListRsp.class);
    }

    @Override
    public int encodedSize(PBTrdFollowListRsp value) {
    ...
    @Override
    public void encode(ProtoWriter writer, PBTrdFollowListRsp value) throws IOException {
    ...
    @Override
    public PBTrdFollowListRsp decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public PBTrdFollowListRsp redact(PBTrdFollowListRsp value) {
