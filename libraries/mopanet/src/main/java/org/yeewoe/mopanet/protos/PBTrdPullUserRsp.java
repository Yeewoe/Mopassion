...
// Source file: merge.proto at 404:1
...
public final class PBTrdPullUserRsp extends Message<PBTrdPullUserRsp, PBTrdPullUserRsp.Builder> {
  public static final ProtoAdapter<PBTrdPullUserRsp> ADAPTER = new ProtoAdapter_PBTrdPullUserRsp();
  ...
  public PBTrdPullUserRsp(Integer result, List<PBTrends> trends) {
    this(result, trends, ByteString.EMPTY);
  }

  public PBTrdPullUserRsp(Integer result, List<PBTrends> trends, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PBTrdPullUserRsp)) return false;
    PBTrdPullUserRsp o = (PBTrdPullUserRsp) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "PBTrdPullUserRsp{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<PBTrdPullUserRsp, Builder> {
    ...
    @Override
    public PBTrdPullUserRsp build() {
      return new PBTrdPullUserRsp(result, trends, buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_PBTrdPullUserRsp extends ProtoAdapter<PBTrdPullUserRsp> {
    ProtoAdapter_PBTrdPullUserRsp() {
      super(FieldEncoding.LENGTH_DELIMITED, PBTrdPullUserRsp.class);
    }

    @Override
    public int encodedSize(PBTrdPullUserRsp value) {
    ...
    @Override
    public void encode(ProtoWriter writer, PBTrdPullUserRsp value) throws IOException {
    ...
    @Override
    public PBTrdPullUserRsp decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public PBTrdPullUserRsp redact(PBTrdPullUserRsp value) {
